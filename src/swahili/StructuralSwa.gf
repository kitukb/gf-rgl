concrete StructuralSwa of Structural = CatSwa ** 
  open MorphoSwa, ParadigmsSwa, DiffSwa, 
 ...
 can8know_VV, can_VV = MorphoSwa.regV "weza";
...
no_Phr = ss "hapana" ;
  ...
  part_Prep, possess_Prep = let
       questo : ParadigmsSwa.Number =>   MorphoSwa.Cgender =>  Str = table {
  ...
  where_IAdv = ss "wapi" ;
  which_IQuant = let
       questo : ParadigmsSwa.Number =>  DiffSwa.Cgender =>  Str =
        table {
